...
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.ENUM(...Object.values(donation_types_1.PaymentMethods)), allowNull: false }),
    __metadata("design:type", String)
], Donation.prototype, "paymentMethod", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.ENUM(...Object.values(donation_types_1.Status)), allowNull: false }),
    __metadata("design:type", String)
...
exports.Donation = Donation = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: "donations", schema: "casa-church", timestamps: true })
], Donation);
