...
let ContactMessage = class ContactMessage extends sequelize_typescript_2.Model {
};
...
__decorate([
    (0, sequelize_typescript_2.Column)({ type: sequelize_typescript_1.DataType.STRING(150), allowNull: false }),
    __metadata("design:type", String)
], ContactMessage.prototype, "subject", void 0);
__decorate([
    (0, sequelize_typescript_2.Column)({ type: sequelize_typescript_1.DataType.STRING(500), allowNull: false }),
    __metadata("design:type", String)
...
exports.ContactMessage = ContactMessage = __decorate([
    (0, sequelize_typescript_2.Table)({ tableName: "contact_messages", schema: "casa-church", timestamps: true })
], ContactMessage);
