...
__decorate([
    (0, swagger_1.ApiProperty)({
        example: registration_types_1.RegistrationStatus.CONFIRMED,
        description: "Novo status da inscrição",
        enum: registration_types_1.RegistrationStatus,
    }),
    (0, class_validator_1.IsNotEmpty)({ message: "O status da inscrição não pode ser vazio" }),
    (0, class_validator_1.IsEnum)(registration_types_1.RegistrationStatus, {
