...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: "O token de confirmacao e obrigatorio." }),
    (0, class_validator_1.IsString)({ message: "O token de confirmacao deve ser um texto." }),
