...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: "O post referente ao comentário não pode ser vazio" }),
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: "O conteúdo do comentário não pode ser vazio" }),
    (0, class_validator_1.IsString)({ message: "O conteúdo do comentário deve ser um texto" }),
